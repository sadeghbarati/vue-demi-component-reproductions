...
import WrapperComponent from './component-2.7'
...
function clickFn() {
  console.log('click event') // without on: listener event won't work
  alert('ok')
}
</script>
  ...
  <div id="app">
    <header>
      ...
      <div class="wrapper">
        ...
        <WrapperComponent @initialize="initializeFn" @before-mount="beforeMountFn" @click="clickFn">
          <h1>Vue 2.7 Component</h1>
          <h2>See console</h2>
        </WrapperComponent>
